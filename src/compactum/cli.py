"""CLI entry points: capsapdf, capsapdf-jpg, capsapdf-pdf."""
...
def jpg_main() -> int:
    ...
    parser.add_argument("--scale", type=float, default=1.5, help="Initial render scale (default: 1.5 — prioritizes hitting target).")
...
def pdf_main() -> int:
    ...
    parser.add_argument("--scale", type=float, default=1.5, help="Initial render scale (default: 1.5).")
    parser.add_argument("--version", action="version", version=__version__)
    args = parser.parse_args()
